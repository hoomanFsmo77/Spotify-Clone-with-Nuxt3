<template>
  <aside  :class="{'!left-0 z-[10]':sidebarFlag}" id="sidebar">
    <div class="banner">
      <NuxtLink :to="{name:'DASHBOARD_INDEX'}">
    ...
    <div v-if="userData" class="pages-list">
      <ul>
        <li class="mb-1.2" v-for="item in sidebarData.section_1" :key="item.id">
    ...
    <div v-if="userData" class="pages-list">
      <ul>
        <li class="mb-1.2" v-for="item in sidebarData.section_2" :key="item.id">
          <NuxtLink active-class="sidebar-list-item-active" exact-active-class="sidebar-list-item-active" class=" sidebar-list-item" :to="item.link">
            <div class=" w-[20%]">
              <font-awesome-icon class="text-1.3 sidebar-list-item-hover" :icon="item.icon" />
            </div>
    ...
    <div v-if="userData" class="user-playlist">
      <ul>
...
const {sidebarData,userPlayListItems,userData}=useSidebar()
</script>
